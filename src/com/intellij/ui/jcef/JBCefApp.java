...
public abstract class JBCefApp {
  ...
  private JBCefApp() {
    ...
    myCefApp = CefApp.getInstance(new String[] { }, config.mySettings);
   ...
   */
  @Deprecated
  public static boolean isEnabled() { return true; //Registry.is("ide.browser.jcef.enabled");
  }
  ...
  public static class CefAppConfig {
    ...
    public CefAppConfig(@NotNull CefSettings settings, String [] appArgs) {
  ...
  private static class JBCefAppWindows extends JBCefApp {
    ...
    protected CefAppConfig getCefAppConfig() {
      ...
      //FIXME - This breaks things, probably because of path. We will probably need to adjust for MacOS, etc too.
